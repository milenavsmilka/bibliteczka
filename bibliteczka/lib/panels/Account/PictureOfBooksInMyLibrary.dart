...
class PictureOfBooksInMyLibrary extends StatefulWidget {
  const PictureOfBooksInMyLibrary({super.key, required this.bookId, required this.isEditingLibrary, required this.categoryUrl});
        ...
        child: Stack(children: [
          ...
          Visibility(
            ...
            child: FloatingActionButton(
              ...
              onPressed: (){
               setState(() {
                  deleteBooksFromMyLibrary(widget.categoryUrl,'book_id',widget.bookId.toString());
